...
action activate_1_zero_2(){
    hdr.inference.features_1 = hdr.inference.features_1 << 1;
}
action activate_2_zero_2(){
    hdr.inference.features_2 = hdr.inference.features_2 << 1;
}
action activate_3_1_zero_2(){
    hdr.inference.features_3_1 = hdr.inference.features_3_1 << 1;
}
action activate_3_2_zero_2(){
    hdr.inference.features_3_2 = hdr.inference.features_3_2 << 1;
}
action activate_4_1_zero_2(){
    hdr.inference.features_4_1 = hdr.inference.features_4_1 << 1;
}
action activate_4_2_zero_2(){
    hdr.inference.features_4_2 = hdr.inference.features_4_2 << 1;
}
action activate_5_zero_2(){
    hdr.inference.features_5 = hdr.inference.features_5 << 1;
}
action activate_6_zero_2(){
    hdr.inference.features_6 = hdr.inference.features_6 << 1;
}
action activate_7_zero_2(){
    hdr.inference.features_7 = hdr.inference.features_7 << 1;
}
...
action activate_1_one_2(){
    hdr.inference.features_1 = hdr.inference.features_1 + 1;
}
action activate_2_one_2(){
    hdr.inference.features_2 = hdr.inference.features_2 + 1;
}
action activate_3_1_one_2(){
    hdr.inference.features_3_1 = hdr.inference.features_3_1 + 1;
}
action activate_3_2_one_2(){
    hdr.inference.features_3_2 = hdr.inference.features_3_2 + 1;
}
action activate_4_1_one_2(){
    hdr.inference.features_4_1 = hdr.inference.features_4_1 + 1;
}
action activate_4_2_one_2(){
    hdr.inference.features_4_2 = hdr.inference.features_4_2 + 1;
}
action activate_5_one_2(){
    hdr.inference.features_5 = hdr.inference.features_5 + 1;
}
action activate_6_one_2(){
    hdr.inference.features_6 = hdr.inference.features_6 + 1;
}
action activate_7_one_2(){
    hdr.inference.features_7 = hdr.inference.features_7 + 1;
}
